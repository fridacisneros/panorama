export interface VedaData {
  ...
  // Periodos de veda en formato "MM-DD", sin año: cada veda aplica el mismo día y
  // mes todos los años. Si el término es anterior al inicio, el periodo cruza el
  // fin de año. Los periodos 2 y 3 son opcionales ("").
  fechaInicio1: string
...
// Formatea una fecha de veda "MM-DD" como "DD/MM".
...
export const isVedaActive = (veda: VedaData): boolean => {
  ...
  // Las fechas son "MM-DD" (sin año): si hoy cae dentro del periodo, está activa.
  const now = new Date()
  const hoy = (now.getMonth() + 1) * 100 + now.getDate()

  // Devuelve mes*100 + día de una fecha "MM-DD", o null.
